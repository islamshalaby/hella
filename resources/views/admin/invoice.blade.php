                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                @if($item->option_id == 0)
                                                                {{ $item->product->offer == 1 ? $item->product->price_before_offer : $item->product->final_price }} 
                                                                @else
                                                                {{ $item->product->offer == 1 ? $item->price_before_offer : $item->final_price }}
                                                                @endif
                                                                {{ __('messages.dinar') }}</td>
                                                            <td class="text-right">{{ $item->option_id == 0 ? $item->product->final_price : $item->final_price }} {{ __('messages.dinar') }}</td>
                                                            <td class="text-right">{{ $item->option_id == 0 ? (double)$item->product->final_price * (double)$item->count : (double)$item->final_price * (double)$item->count }} {{ __('messages.dinar') }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-sm-7 col-12 order-sm-1 order-0">
                                            <div class="inv--total-amounts text-sm-right">
                                                <div class="row">
                                                    ...
                                                    @if($data['order']['discount_value'] > 0)
                                                    <div class="col-sm-8 col-7">
                                                        <p class="">{{ __('messages.discount_coupon') }}: </p>
                                                    </div>
                                                    <div class="col-sm-4 col-5">
                                                        <p class="">{{ $data['order']['discount_value'] }} {{ __('messages.dinar') }}</p>
                                                    </div>
                                                    @endif
