...
@push('scripts')
    ...
    <script>
        var price = dTbls.column(6).data(),
            ...
            totalDiscount = dTbls.column(8).data(),
        ...
        var totalPrice = parseFloat(price.reduce(function (a, b) { return parseFloat(a) + parseFloat(b); }, 0)).toFixed(2),
            ...
            allTotalDiscount = parseFloat(totalDiscount.reduce(function (a, b) { return parseFloat(a) + parseFloat(b); }, 0)).toFixed(2),
        ...
        $("#order-tbl tfoot").find('th').eq(8).text(`${allTotalDiscount} ${dinar}`);
                ...
                <table id="order-tbl" class="table table-hover non-hover" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('messages.discount_coupon') }}</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($data['orders'] as $order)
                            <tr>
                                ...
                                <td>{{ $order->discount_value . " " . __('messages.dinar') }}</td>
