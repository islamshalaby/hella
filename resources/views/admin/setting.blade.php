    ...
    <form method="post" action="" enctype="multipart/form-data" >
        @csrf
         <div class="form-group mb-4">
            ...
            <br>
            <img src="https://res.cloudinary.com/dzqo7w4cp/image/upload/w_100,q_100/v1600733461/{{$data['setting']['logo']}}" >    
        </div>
        ...
        <div class="form-group mb-4">
            <label for="min_free_delivery">{{ __('messages.min_free_delivery') }}</label>
            <input  type="number" min="0" step="any" name="min_free_delivery" class="form-control" id="min_free_delivery" placeholder="{{ __('messages.min_free_delivery') }}" value="{{$data['setting']['min_free_delivery']}}" >
        </div>
        <div class="form-group mb-4">
