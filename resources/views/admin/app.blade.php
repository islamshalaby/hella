        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="/admin-panel">
                        <img src="https://res.cloudinary.com/dzqo7w4cp/image/upload/w_100,q_100/v1600733461/<?=Auth::user()->custom['setting']['logo']?>" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                   ...
                   @if(in_array(1 , Auth::user()->custom['admin_permission'])) 
                    ...
                    @if(in_array(15 , Auth::user()->custom['admin_permission']))
                    <li class="menu sub_categories_two">
                        <a href="#sub_categories_two" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                                <span>{{ __('messages.sub_cat_two') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="sub_categories_two" data-parent="#accordionExample">
                            @if(Auth::user()->add_data) 
                                <li class="active add">
                                    <a href="{{ route('sub_categories_two.add') }}"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="{{ route('sub_categories_two.index') }}"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu discount_coupons">
                        <a href="#discount_coupons" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                ...
                                <span>{{ __('messages.disount_coupons') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="discount_coupons" data-parent="#accordionExample">
                            @if(Auth::user()->add_data) 
                                <li class="active add">
                                    <a href="{{ route('discount_coupons.add') }}"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="{{ route('discount_coupons.index') }}"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
