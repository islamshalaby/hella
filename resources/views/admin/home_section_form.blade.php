                                ...
                                <div class="col-md-3" >
                                    <div >
                                        <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                            ...
                                            <span class="new-control-indicator"></span><span class="new-chk-content"><img src="https://res.cloudinary.com/dzqo7w4cp/image/upload/w_100,q_100/v1600733461/${ad.image}" /></span>
                                        </label>
                                    </div>     
                                </div>
                            `)
